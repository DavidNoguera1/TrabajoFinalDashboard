...
function DashboardLayout({children}: Props) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      {/* Sidebar */}
      <aside className={`w-full md:w-64 bg-surface border-r border-slate-800 p-6 flex flex-col ${
        ...
        <nav className="flex-1">
          <ul className="space-y-2">
            <li>
              <a href="#" className="flex items-center gap-3 px-4 py-3 bg-blue-500/10 text-primary rounded-lg font-medium border border-blue-500/20 hover:bg-blue-500/20 transition-colors">
                <span>Dashboard</span>
              </a>
            </li>
          </ul>
